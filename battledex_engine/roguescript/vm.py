...
RogueScriptRuntimeError and does *not* print errors,
to allow the test harness to handle them.
"""
...
def native_use_move(args: list) -> str:
    ...
    # SILENCED: print(f"[BATTLEDEX_ENGINE] Using move: {move_name}")
    ...
    def run(self) -> (InterpretResult, any):
        ...
        while True:
            ...
            # --- Unary Ops ---
                ...
                if not isinstance(self.peek(0), (int, float, bool)): # Allow bool
                    self._runtime_error("Operand must be a number or boolean.")
                
                value = self.pop()
                if isinstance(value, bool):
                    value = 1 if value else 0 # Coerce bool to number
            ...
            # --- Binary Ops ---
                ...
                if op == OpCode.OP_ADD:
                    ...
                    # Coerce bools for numeric operations
